...
folder are mapped to the application's root namespace, 'LayoutApp'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'LayoutApp' in the same way
as `"LayoutApp/sass/src"`.
